// list the sequences in source ncbi-curated-deltaretrovirus
var listSeqResult = glue.command(["list", "sequence", "-w", "source.name = 'ncbi-curated-deltaretrovirus'"]);
...
_.each(seqIds, function(seqId) {
    ...
    glue.inMode("sequence/ncbi-curated-deltaretrovirus/"+seqId, function() {
